...
def lambda_handler(event, context):
            ...
            if event["RequestType"] == "Create" or event["RequestType"] == "Update":
              try:
                  ...
                  policy_deploy_name = 'SandboxGuardrails'
                  ...
                  if  policy_deploy_name in deploypolicyname:
                    ...
                    policy_deploy_resources = client.create_policy(
                      Content='{"Version":"2012-10-17","Statement":[{"Sid":"SandboxGuardrails","Effect":"Deny","Action":["states:*"],"Resource":["arn:aws:states:*:*:stateMachine:StepFunctionMonitoring"],"Condition":{"ArnNotLike":{"aws:PrincipalARN":["arn:aws:iam::*:role/RoleForStepFunctionSandboxAccount","arn:aws:iam::*:role/RoleForLambdaAccessResources","arn:aws:iam::*:role/AWSControlTowerExecution","arn:aws:iam::*:role/RoleCWE"]}}},{"Sid":"ProtectCodeBuild","Effect":"Deny","Action":["codebuild:*"],"Resource":["arn:aws:codebuild:*:*:project/AccountNuker-List","arn:aws:codebuild:*:*:project/AccountNuker-Delete"],"Condition":{"ArnNotLike":{"aws:PrincipalARN":["arn:aws:iam::*:role/RoleForCodeBuildSandbox","arn:aws:iam::*:role/RoleForLambdaAccessResources","arn:aws:iam::*:role/AWSControlTowerExecution"]}}},{"Sid":"ProtectSSMParameterStore","Effect":"Deny","Action":["ssm:*"],"Resource":["arn:aws:ssm:*:*:parameter/account_days","arn:aws:ssm:*:*:parameter/account_id","arn:aws:ssm:*:*:parameter/account_initial","arn:aws:ssm:*:*:parameter/ec2_limit"],"Condition":{"ArnNotLike":{"aws:PrincipalARN":["arn:aws:iam::*:role/RoleForLambdaAccessResources","arn:aws:iam::*:role/RoleForCodeBuildSandbox","arn:aws:iam::*:role/RoleForStepFunctionSandboxAccount","arn:aws:iam::*:role/AWSControlTowerExecution"]}}},{"Sid":"ProtectLambda","Effect":"Deny","Action":["lambda:*"],"Resource":["arn:aws:lambda:*:*:function:MonitoringFuction","arn:aws:lambda:*:*:function:DeleteAccount","arn:aws:lambda:*:*:function:MissingDaysFunction","arn:aws:lambda:*:*:function:ListResources","arn:aws:lambda:*:*:function:IncreaseLimitEC2Function"],"Condition":{"ArnNotLike":{"aws:PrincipalARN":["arn:aws:iam::*:role/RoleForLambdaAccessResources","arn:aws:iam::*:role/RoleForCodeBuildSandbox","arn:aws:iam::*:role/RoleForStepFunctionSandboxAccount","arn:aws:iam::*:role/AWSControlTowerExecution"]}}},{"Sid":"ProtectIAMRoles","Effect":"Deny","Action":["iam:*"],"Resource":["arn:aws:iam::*:role/RoleForLambdaAccessResources","arn:aws:iam::*:role/RoleForCodeBuildSandbox","arn:aws:iam::*:role/RoleForStepFunctionSandboxAccount","arn:aws:iam::*:role/RoleCWE"],"Condition":{"ArnNotLike":{"aws:PrincipalARN":["arn:aws:lambda:*:*:function:MonitoringFuction","arn:aws:lambda:*:*:function:DeleteAccount","arn:aws:lambda:*:*:function:MissingDaysFunction","arn:aws:lambda:*:*:function:ListResources","arn:aws:lambda:*:*:function:ExecuteCWE","arn:aws:lambda:*:*:function:IncreaseLimitEC2Function","arn:aws:codebuild:*:*:project/AccountNuker-List","arn:aws:codebuild:*:*:project/AccountNuker-Delete","arn:aws:states:*:*:stateMachine:StepFunctionMonitoring","arn:aws:iam::*:role/AWSControlTowerExecution","arn:aws:sns:*:*:Sandbox-SNSTopic","arn:aws:ssm:*:*:parameter/account_days","arn:aws:ssm:*:*:parameter/account_id","arn:aws:ssm:*:*:parameter/account_initial","arn:aws:ssm:*:*:parameter/ec2_limit","arn:aws:servicequotas:*::ec2/L-1216C47A"]}}},{"Sid":"ProtectCloudWatchEventRule","Effect":"Deny","Action":["events:*"],"Resource":["arn:aws:events:*:*:rule/Sandbox-MonitoringEventRule"],"Condition":{"ArnNotLike":{"aws:PrincipalARN":["arn:aws:iam::*:role/RoleCWE","arn:aws:iam::*:role/AWSControlTowerExecution"]}}}]}',
